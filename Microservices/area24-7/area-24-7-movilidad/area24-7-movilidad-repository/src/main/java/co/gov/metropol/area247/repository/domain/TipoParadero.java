...
@Entity
@Table(name = "D247VIA_TIPO_PARADERO", schema = "MOVILIDAD")
public class TipoParadero extends Entities {
	...
	@Override
	public TipoParadero withId(Long id) {
		super.setId(id);
		return this;
	}

	@Override
	public TipoParadero withEnabled(boolean enabled) {
