 ...
 */
@Entity
@Table(name = "T247VIA_VIAJES_RUTA", schema = "MOVILIDAD")
public class ViajesRuta extends Entities {

	private static final long serialVersionUID = -7048026727384209262L;
	...
	@Override
	public ViajesRuta withId(Long id) {
		super.setId(id);
		return this;
	}

	@Override
	public ViajesRuta withEnabled(boolean enabled) {
