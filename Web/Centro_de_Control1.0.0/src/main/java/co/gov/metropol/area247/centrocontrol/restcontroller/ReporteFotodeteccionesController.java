...
@Controller
@RequestMapping("/archivos/reporte/fotodetecciones")
public class ReporteFotodeteccionesController extends BaseController {
	
	@Value("${area247.reporte.powerbi.groupId}")
	private String groupId;
	
	@Value("${area247.reporte.powerbi.fotodeteccionesId}")
	...
	public String get(Model model, Area247WebRequest area247WebRequest){
		...
		model.addAttribute("reporteNombre", "Fotodetecciones");
		model.addAttribute("groupId", groupId);
		model.addAttribute("reportId", reportId);
		
		model.addAttribute("title", "Reporte de Fotodetecciones");
