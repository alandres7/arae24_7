...
@Controller
@RequestMapping("/archivos/reporte/minimarecorrida")
public class ReporteDistanciaMinimaRecorrida {

	@Value("${area247.reporte.powerbi.groupId}")
	private String groupId;
	
	@Value("${area247.reporte.powerbi.distanciaMinimaRecorridaId}")
	...
	public String get(Model model, Area247WebRequest area247WebRequest){
		...
		model.addAttribute("reporteNombre", "Distancia Minima Recorrida");
		model.addAttribute("groupId", groupId);
		model.addAttribute("reportId", reportId);
		
		model.addAttribute("title", "Distancia Minima Recorrida");
